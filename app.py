...
class TextForm1(Form):
    enter = TextAreaField('Enter your text',validators=[Required()],  render_kw={"rows": 18, "cols": 150})
    submit = SubmitField('Analyze')

class TextForm2(Form):
    enter = TextAreaField('Here will be your anonimized text',validators=[Required()], render_kw={"rows": 18, "cols": 150})
